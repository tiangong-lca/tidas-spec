...
const base = {
  ...
  archiveFile: 'tiangong-lca-tidas-spec-0.1.0.tgz',
  ...
  archiveUrl: 'https://github.com/tiangong-lca/tidas-spec/releases/download/v0.1.0/tiangong-lca-tidas-spec-0.1.0.tgz',
};
...
test('release notification has a stable idempotency key and exact digests', () => {
  ...
  assert.match(first.client_payload.event_key, /@0\.1\.0:638d4d72.*:fe82b774/u);
